...
commit_hw_vio [get_hw_probes {ACCUM_reset} -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"U_vio_PS_CTRL"}]]
set_property OUTPUT_VALUE 00001000 [get_hw_probes FORCE_STEP_VAL -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"U_vio_PS_CTRL"}]]
commit_hw_vio [get_hw_probes {FORCE_STEP_VAL} -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"U_vio_PS_CTRL"}]]
set_property OUTPUT_VALUE 0 [get_hw_probes DBG_PS_FORCE -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"U_vio_PS_CTRL"}]]
commit_hw_vio [get_hw_probes {DBG_PS_FORCE} -of_objects [get_hw_vios -of_objects [get_hw_devices xcku040_0] -filter {CELL_NAME=~"U_vio_PS_CTRL"}]]
