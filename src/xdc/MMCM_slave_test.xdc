...
set_clock_groups -asynchronous -group [get_clocks -of_objects [get_pins U_mmcm_300Mhz_in_Master/inst/mmcme3_adv_inst/CLKOUT0]] -group [get_clocks -of_objects [get_pins U_mmcm_ps/inst/mmcme3_adv_inst/CLKOUT0]]
